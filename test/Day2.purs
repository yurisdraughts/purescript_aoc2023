  ...
  suite "Day 2" do
    ...
    suite "parseGame" do
      ...
      suite "wrong inputs result" do
        ...
        suite "no space after semicolon \
          \(id is correctly identified, but not subsets)" do
          test game1 do
            Assert.equal result1 $ Day2.parseGame game1
        suite "no space after colon \
          \(id and the first subset are correctly identified, \
          \but the remaining two subsets are not separated)" do
          test game2 do
            Assert.equal result2 $ Day2.parseGame game2
        suite "two semicolons \
          \(id and the first subset are correctly identified, \
          \but the rest are missing)" do
          test game3 do
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""
        ...
        suite "wrong input" do
          let input1 = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 greenGame 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red"""
